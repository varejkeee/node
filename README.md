...
Base is a secure, low-cost, developer-friendly Ethereum Layer 2 built to bring the next billion users onchain. It's built on Optimism’s open-source [OP Stack](https://stack.optimism.io/).
